...
const StudentMyLectureList: React.FC = () => {
                                ...
                                <div className="flex justify-center items-center col-span-1">
                                  {daysAgo > 0 ? (
                                    ...
                                    <button
                                      onClick={() =>
                                        navigate(
                                          `/classroom/${lecture.lecture_id}`
                                        )
                                      }
                                      className="p-3 bg-sky-300 rounded-md text-white font-semibold hover:bg-sky-400"
                                    >
                                      강의실 입장하기
                                    </button>
                                  )}
...
export default StudentMyLectureList;
